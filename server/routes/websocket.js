                    ...
                    if (data.isPlayCard == 'true') {//玩家出牌
                        if (GetCardType(data.showOutCardVal) != 'None') {//牌型正常符合
                            if (data.seat == 'leftPlayer') {
                                ...
                                if ((hallData[i].bottomPlayer.showOutCard.length == 0 || hallData[i].bottomPlayer.showOutCard[0] == 'notOut')
                                    && (hallData[i].rightPlayer.showOutCard.length == 0 || hallData[i].rightPlayer.showOutCard[0] == 'notOut')) {
                                    ...
                                    (function (i) {
                                        ...
                                        hallData[i].leftPlayer.showOutCard = data.showOutCardIcon;//存储当前玩家出的牌
                                        hallData[i].leftPlayer.playCard = 'false';//清除轮到当前玩家出牌状态
                                        hallData[i].bottomPlayer.playCard = 'true';// 出牌状态赋值给下一家
                                        hallData[i].bottomPlayer.showOutCard = [];// 删除下一玩家 上轮是否出牌 已出的牌
                            ...
                            if (data.seat == 'bottomPlayer') {
                                // 当前是地主第一次出牌  或者其余两名玩家上轮不要  (无需比牌大小)
                                if ((hallData[i].rightPlayer.showOutCard.length == 0 || hallData[i].rightPlayer.showOutCard[0] == 'notOut')
                                    && (hallData[i].leftPlayer.showOutCard.length == 0 || hallData[i].leftPlayer.showOutCard[0] == 'notOut')) {
                                    ...
                                    (function (i) {
                                        ...
                                        hallData[i].bottomPlayer.showOutCard = data.showOutCardIcon;//存储当前玩家出的牌
                                        hallData[i].bottomPlayer.playCard = 'false';//清除轮到当前玩家出牌状态
                                        hallData[i].rightPlayer.playCard = 'true';// 出牌状态赋值给下一家
                                        hallData[i].rightPlayer.showOutCard = [];// 删除下一玩家 上轮是否出牌 已出的牌
                            ...
                            if (data.seat == 'rightPlayer') {
                                // 当前是地主第一次出牌  或者其余两名玩家上轮不要  (无需比牌大小)
                                if ((hallData[i].leftPlayer.showOutCard.length == 0 || hallData[i].leftPlayer.showOutCard[0] == 'notOut')
                                    && (hallData[i].bottomPlayer.showOutCard.length == 0 || hallData[i].bottomPlayer.showOutCard[0] == 'notOut')) {
                                    ...
                                    (function (i) {
                                        ...
                                        hallData[i].rightPlayer.showOutCard = data.showOutCardIcon;//存储当前玩家出的牌
                                        hallData[i].rightPlayer.playCard = 'false';//清除轮到当前玩家出牌状态
                                        hallData[i].leftPlayer.playCard = 'true';// 出牌状态赋值给下一家
                                        hallData[i].leftPlayer.showOutCard = [];// 删除下一玩家 上轮是否出牌 已出的牌
                        ...
                        hallData[i][data.seat].showOutCard.push('notOut');
